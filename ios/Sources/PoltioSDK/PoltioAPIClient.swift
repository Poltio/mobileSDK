...
internal final class PoltioAPIClient {
    
    /// Default base URL for the Poltio SDK API.
    internal static let defaultBaseURL = "https://sdk-stage.poltio.com"
    
    /// Endpoint path for resolving mobile widgets.
    internal static let widgetEndpointPath = "/sdk/mobile/v1/widget"
    ...
    internal func resolveMobileWidget(
        clientKey: String,
        deviceId: String,
        targetURL: String,
